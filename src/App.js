...
import { SearchOutlined, DeleteOutlined, QuestionCircleOutlined, InfoCircleOutlined } from '@ant-design/icons';
...
export default class index extends Component {
    ...
    this.mapEvents = {
      click(e) {
        _this.setState({
          ...
          inputLng: e.lnglat.lng,
          inputLat: e.lnglat.lat
        })
      },
    };
    /**
  ...
  */
  ...
  render() {
    const { longitude, latitude, inputLng, inputLat, altitude, elevUint, model, modelDesc, modelName, utc, drwaerVisible, modalVisible,
      calcStatus, resMsg, storageVisible, detailVisible, resDataSource, calcDataSource, calcStgParamData, calcStgResData, calcTime } = this.state;
    return (
      <div className="main">
        ...
        <div className="content">
          <div className="params-container">
            <div className="param">
              ...
              <Tooltip placement="top" title="经度范围-180~180">
                <InputNumber value={inputLng} max={180} min={-180} placeholder="-180~180" onChange={this.handleChangeLngLat.bind(this, "inputLng")} formatter={value => `${value} °`} />
              </Tooltip>
            </div>
            <div className="param">
              <span className="param-label">纬度：</span>
              <Tooltip placement="top" title="纬度范围-90~90">
                <InputNumber value={inputLat} max={90} min={-90} placeholder="-90~90" onChange={this.handleChangeLngLat.bind(this, "inputLat")} formatter={value => `${value} °`} />
              </Tooltip>
            </div>
            <div className="param">
            ...
            <div className="param">
              <span className="param-label">磁场模型：</span>
            ...
            {/* <div className="param param-date">
              <span className="param-label">年 - 月 - 日：</span>
              <Tooltip placement="right" title="年范围2000~2020">
                <InputNumber defaultValue={minYear} max={2020} min={2000} precision={0} placeholder="2000~2020" onChange={this.handleChangeParam.bind(this, "minYear")} />
              </Tooltip>
              &nbsp;-&nbsp;
              <InputNumber defaultValue={minMonth} max={12} min={1} precision={0} placeholder="1~12" onChange={this.handleChangeParam.bind(this, "minMonth")} />
              &nbsp;-&nbsp;
              <InputNumber defaultValue={minDay} max={31} min={1} precision={0} placeholder="1~31" onChange={this.handleChangeParam.bind(this, "minDay")} />
            </div> */}
            {/*<div className="param">
              <span className="param-label">年：</span>
              <Tooltip placement="right" title="年范围2000~2020">
                <InputNumber defaultValue={minYear} max={2020} min={2000} precision={0} placeholder="2000~2020" onChange={this.handleChangeParam.bind(this, "minYear")} />
              </Tooltip>
            </div> 
            <div className="param">
              <span className="param-label">月：</span>
              <InputNumber defaultValue={minMonth} max={12} min={1} precision={0} placeholder="1~12" onChange={this.handleChangeParam.bind(this, "minMonth")} />
            </div>
            <div className="param">
              <span className="param-label">日：</span>
              <InputNumber defaultValue={minDay} max={31} min={1} precision={0} placeholder="1~31" onChange={this.handleChangeParam.bind(this, "minDay")} />
            </div> */}
            <div className="param">
            ...
            {/* <div className="param">
              ...
              <InputNumber defaultValue={hour} max={23} min={0} precision={0} placeholder="0~23" onChange={this.handleChangeParam.bind(this, "hour")} />
            </div>
            <div className="param">
              <span className="param-label">分：</span>
              <InputNumber defaultValue={minute} max={59} min={0} precision={0} placeholder="0~59" onChange={this.handleChangeParam.bind(this, "minute")} />
            </div> */}
            <div className="param">
          ...
          <div className="map-container">
            <Map plugins={mapPlugins} viewMode="3D" amapkey="3dabe81a1752997b9089ccb0b1bfcecb" center={[longitude, latitude]} zoom={3} events={this.mapEvents} doubleClickZoom={false}>
